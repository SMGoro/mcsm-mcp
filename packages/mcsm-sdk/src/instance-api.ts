/**
 * MCSManager SDK - Instance Management Module
 * Provides methods for managing instances
 */

import { InstanceDetail } from "./api-types.js";
import { MCSManagerSDK } from "./core-api.js";

// Extend the core SDK with instance management methods
export class InstanceAPI extends MCSManagerSDK {
  // ============ Instance Management ============
